        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    <li><a href="<?php echo base_url(); ?>controller_owner/c_owner_rak"><i class="fa fa-users"></i> Rak <span class="fa fa-chevron-right"></span></a>
                    </li>
                    <li><a href="<?php echo base_url(); ?>controller_owner/c_owner_data_kriteria"><i class="fa fa-folder-open"></i> Data Kriteria <span class="fa fa-chevron-right"></span></a>
                        
                    </li>
                    <li><a><i class="fa fa-user"></i> Data Pegawai <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu" style="display: none">
                            <li><a href="<?php echo base_url();?>controller_owner/c_owner_pegawai">Lihat Data Pegawai</a>
                            </li>
                            <li><a href="<?php echo base_url(); ?>controller_owner/c_owner_pegawai_tambah">Tambah Data Pegawai</a>
                            </li>
                        </ul>
                    </li>
                    <li><a><i class="fa fa-pagelines"></i> Data Jamur <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu" style="display: none">
                            <li><a href="<?php echo base_url(); ?>controller_owner/c_owner_core">Data Promethee</a>
                            </li>
                        </ul>
                    </li>
                </ul>
