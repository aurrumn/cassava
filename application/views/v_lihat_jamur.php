                    ...
                    <div class="col-middle" role="main">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h3>Data Supply Jamur <small>| menampilkan semua data jamur</small></h3>
                                    ...
                                    <div class="x_content">
                                        ...
                                        <table style="text-align: center" id="tabel_jamur" class="table table-striped responsive-utilities jambo_table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align: center">ID Jamur</th>
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                foreach ($jamur->result_array() as $value) {
                                                    ?>
                                                    <tr>
                                                        <td style="vertical-align: middle"><?php echo $no++ ?></td>
                                                        <td style="vertical-align: middle"><?php echo $value['id_jamur'] ?></td>
                                        ...
                                        <div class="">
                                            <p class="pull-right">Lihat Seluruh Jamur |
